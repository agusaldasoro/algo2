    ...
    ************************************/
    class Iterador
    {
      public:
        ...
        ///Pre: elem no pertenece  al conjunto
        void AgregarComoSiguiente(const T& elem); ///Modificado por Nicolas Chamo
        void AgregarComoAnterior(const T& elem); ///Modificado por Nicolas Chamo
...
///Modificado por Nicolas Chamo
template<class T>
void Conj<T>::Iterador::AgregarComoSiguiente(const T& elem)
{
   it_dicc_.AgregarComoSiguiente(elem, true);
}

///Modificado por Nicolas Chamo
template<class T>
void Conj<T>::Iterador::AgregarComoAnterior(const T& elem)
{
    it_dicc_.AgregarComoAnterior(elem, true);
}
